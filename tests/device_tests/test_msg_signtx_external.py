...
@pytest.mark.skip_t1
class TestMsgSigntxExternal:
    def test_p2pkh_presigned(self, client):
    ...
    def test_p2wpkh_in_p2sh_presigned(self, client):
        inp1 = proto.TxInputType(
    ...
    def test_p2wpkh_presigned(self, client):
        inp1 = proto.TxInputType(
    ...
    def test_p2wsh_external_presigned(self, client):
        inp1 = proto.TxInputType(
    ...
    def test_p2pkh_with_proof(self, client):
        # TODO
        pass

    def test_p2wpkh_in_p2sh_with_proof(self, client):
        # TODO
        pass

    def test_p2wpkh_with_proof(self, client):
        inp1 = proto.TxInputType(
    ...
    def test_p2wpkh_with_false_proof(self, client):
        inp1 = proto.TxInputType(
            # tb1qkvwu9g3k2pdxewfqr7syz89r3gj557l3uuf9r9
            address_n=parse_path("m/84h/1h/0h/0/0"),
            prev_hash=TXHASH_70f987,
